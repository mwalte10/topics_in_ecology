...
model <- function(t, y, parms){
  ...
  dS1_h <-  
    ...
    S1_h * delta -
    S1_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0}
  dS1_l <-  
    mu * c(pop_l, rep(0,27)) +
    ...
    S1_l * delta - 
    S1_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0}
  ...
  dR1_h <-
    ...
    R1_h * delta +
    S1_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0} - 
    R1_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0}
  dR1_l <-
    I1_l * gamma +
    ...
    R1_l * delta +
    S1_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0} - 
    R1_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0}
  ...
  dS2_h <- 
    ...
    S2_h * delta - 
    S2_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0}
  dS2_l <- 
    R1_l * sigma +
    ...
    S2_l * delta - 
    S2_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0}
  ...
  dR2_h <-  
    ...
    R1_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0} +
    S2_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0} -
    R2_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0}
  dR2_l <-  
    I2_l * gamma +  
    ...
    R1_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0} +
    S2_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0} -
    R2_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0}
  ...
  dS3_h <- 
    ...
    S3_h * delta -
    S3_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0}
  dS3_l <- 
    R2_l * sigma + 
    ...
    S3_l * delta -
    S3_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0}
  ...
  dR3_h <- 
    ...
    R2_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0} +
    S3_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0} -
    R3_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0}
  dR3_l <- 
    I3_l * gamma +
    ...
    R3_l * sigma -
    R3_l * delta +
    R3_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0} +
    S3_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0} - 
    R3_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0}
  ...
  dS4_h <- 
    ...
    S4_h * delta - 
    S4_h * if(t>365*30*10){vac_h = vac_h}else{vac_h = 0}
  dS4_l <- 
    R3_l * sigma +
    ...
    S4_l * delta - 
    S4_l * if(t>365*30*10){vac_l = vac_l}else{vac_l = 0}
