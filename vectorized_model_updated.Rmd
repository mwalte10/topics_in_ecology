...
population <- sum(y)
    ...
    dI1 <- 
      ...
      + (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(I1, -1), 0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(I1, - 1), 0)
      - I1 * gamma - I1 * delta
    
    dR1 <-
      I1  * gamma 
      + (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(R1, -1), 0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(R1, - 1), 0)
      - R1 * sigma - R1 * delta
    ...
    dS2 <- 
      ...
      + (1/365)* c((1/c(head(age_window, -1))), 0) * c(head(S2, -1),0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) *c(head(S2, - 1), 0)
      + sigma * R1 
    
    dI2 <- 
      S2 * ((3/4) * beta * infected_total / population)
      + (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(I2, -1), 0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(I2, - 1), 0)
      - I2  * gamma - I2 * delta
    
    dR2 <-  
      I2  * gamma  
      + (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(R2, -1), 0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(R2, - 1), 0)
      - R2  * sigma - R2 * delta
    ...
    dS3 <- 
      ...
      + (1/365)* c((1/c(head(age_window, -1))), 0) * c(head(S3, -1),0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) *c(head(S3, - 1), 0) 
      + sigma * R2 
    
    dI3 <- 
      S3 * ((2/4) * beta * infected_total / population) 
      + (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(I3, -1), 0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(I3, - 1), 0)
      - I3  * gamma - I3 * delta
    
    dR3 <- 
      I3  * gamma  
      + (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(R3, -1), 0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(R3, - 1), 0)
      - R3 * sigma - R3 * delta
    ...
    dS4 <- 
      ...
      + (1/365)* c((1/c(head(age_window, -1))), 0) * c(head(S4, -1),0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) *c(head(S4, - 1), 0)
      + sigma * R3 
    
    dI4 <- 
      S4 * ((1/4) * beta * infected_total / population) 
      + (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(I4, -1), 0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(I4, - 1), 0)
      - I4 * gamma - I4 * delta
    
    dR4 <- 
      I4 * gamma  
      + (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(R4, -1), 0)
      - (1/365) * c((1/c(head(age_window, -1))), 0) * c(head(R4, - 1), 0)
      - R4 * (delta) 
