...
susceptible_init_h[,3] <- c(initial_conditions[1:80,3] * 0.25, initial_conditions[81:160,3] * 0, 
...
susceptible_init_l[,3] <- c(initial_conditions[1:80,3] * 0.75, initial_conditions[81:160,3] * 0, 
                            initial_conditions[161:240,3] * 0, initial_conditions[241:320,3] * 0)
