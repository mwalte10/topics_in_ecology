...
beta_l.vec <- seq(0, 0.6, length.out = 50)
...
####SP9 Calcs
{
  ...
  save(sp9.vec, file = paste('sp9_whole_pop_', input, '.RData', sep = ''))
...
#   }
#   save(output.vec.h, file = paste('output_mod_trav_notest_', input, '.RData', sep = ''))
#   
#   
#   # 
# }
