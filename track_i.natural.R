...
save(track_infected, file = paste('track.infected.nat_', input, '.RData', sep = ''))
save(track_l, file = paste('track.l.nat_', input, '.RData', sep = ''))
save(track_h, file = paste('track.h.nat_', input, '.RData', sep = ''))
