...
beta_h <- beta.mat[input,1]
beta_l <- beta.mat[input,2]
...
susceptible_init_h[,3] <- fill_suscep(prop.h.1 = 0.75 , prop.h.2=0,  prop.h.3=0,  prop.h.4=0, prop.l.1 = 0.25, prop.l.2=0,  prop.l.3=0, prop.l.4=0)[[1]]
susceptible_init_l[,3] <-  fill_suscep(prop.h.1 = 0.75 , prop.h.2=0,  prop.h.3=0,  prop.h.4=0, prop.l.1 = 0.25, prop.l.2=0,  prop.l.3=0, prop.l.4=0)[[2]]
