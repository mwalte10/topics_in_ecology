...
#Trajectories for cases and infections
{
  png(filename = paste('track_cases.nv_', input, '.png', sep = ''))
  plot(cases, type = "l", col = "purple", main = "Cases over time")
  lines(cases.l, col = "red")
  lines(cases.h, col = "blue")
  legend("topleft", c("Cases, whole", "Cases, high transmission", "Cases, low transmission"),
         col = c("purple", "red", "blue"), lty = rep(1,3))
  dev.off()
  
  png(filename = paste('track_infections.nv_', input, '.png', sep = ''))
  plot(track_infected, type = "l", col = "purple", main = "Infections over time")
  lines(track_l, col = "red")
  lines(track_h, col = "blue")
  legend("topleft", c("Infections, whole", "Infections, high transmission", "Infections, low transmission"),
         col = c("purple", "red", "blue"), lty = rep(1,3))
  dev.off()
}
