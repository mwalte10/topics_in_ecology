...
#SAVED FILES
{save(out_last, file = paste('output.vactest_', input, '.RData', sep = ''))
save(track_infected, file = paste('track.infected.vactest_', input, '.RData', sep = ''))
save(track_l, file = paste('track.l.vactest_', input, '.RData', sep = ''))
save(track_h, file = paste('track.h.vactest_', input, '.RData', sep = ''))
save(cases, file = paste('cases.vactest_', input, '.RData', sep = ''))
save(cases.l, file = paste('cases.l.vactest_', input, '.RData', sep = ''))
save(cases.h, file = paste('cases.h.vactest_', input, '.RData', sep = ''))}
...
save(sp9, file = paste('sp9.vactest_', input, '.RData', sep = ''))
...
save(sp9.l, file = paste('sp9.l.vactest_', input, '.RData', sep = ''))
...
save(sp9.h, file = paste('sp9.h.vactest_', input, '.RData', sep = ''))}
