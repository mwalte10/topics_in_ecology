...
times <- seq(from = 0, to = 365 * 3, by = .1)
...
legend(800, 8e5, legend=c("Susceptible 1", "Susceptible 2", "Susceptible 3", "Susceptible 4"),
...
legend(800, 8e5, legend=c("Infected 1", "Infected 2", "Infected 3", "Infected 4"),
       col=c("black","red", "blue","green"), lty=1, cex=0.8)
}
...
legend(800, 8e5, legend=c("Recovered 1", "Recovered 2", "Recovered 3", "Recovered 4"),
       col=c("black","red", "blue","green"), lty=1, cex=0.8)
}
##With the appropriate scale
{plot(out[,1],rowSums(out[,(1+(3-1)*28+1):(1+(3)*28)]),type='l', ylim= range(0:1e8), main = "Recovered")
lines(out[,1],rowSums(out[,(1+(6-1)*28+1):(1+(6)*28)]),type='l', col ="red")
lines(out[,1],rowSums(out[,(1+(9-1)*28+1):(1+(9)*28)]),type='l', col ="blue")
lines(out[,1],rowSums(out[,(1+(12-1)*28+1):(1+(12)*28)]),type='l', col ="green")
legend(800, 8e7, legend=c("Recovered 1", "Recovered 2", "Recovered 3", "Recovered 4"),
       col=c("black","red", "blue","green"), lty=1, cex=0.8)
}
