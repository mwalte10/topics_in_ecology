...
S1_names <- c(assign(paste( "S_1_", 1:28, sep='')))

plot(out, main = c(assign(paste( "S_1_", 1:28, sep='')), 
                   assign(paste( "I_1_", 1:28, sep='')),
                   assign(paste( "R_1_", 1:28, sep='')),
                   assign(paste( "S_2_", 1:28, sep='')), 
                   assign(paste( "I_2_", 1:28, sep='')),
                   assign(paste( "R_2_", 1:28, sep='')),
                   assign(paste( "S_3_", 1:28, sep='')), 
                   assign(paste( "I_3_", 1:28, sep='')),
                   assign(paste( "R_3_", 1:28, sep='')),
                   assign(paste( "S_4_", 1:28, sep='')), 
                   assign(paste( "I_4_", 1:28, sep='')),
                   assign(paste( "R_4_", 1:28, sep=''))))
```
